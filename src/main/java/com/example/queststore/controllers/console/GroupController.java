...
import com.example.queststore.views.console.GroupView;
...
public class GroupController {
    ...
    public GroupController(GroupView groupView, MentorView mentorView, GroupDAO groupDAO, UserDAO userDAO,
